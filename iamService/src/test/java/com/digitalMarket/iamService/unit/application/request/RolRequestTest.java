...
public class RolRequestTest {
    ...
    void initRolRequest() {
        ...
        rolRequest.setNombre("ADMINISTRADOR");
        rolRequest.setDescripcion("Gestiona asignacion de roles y permisos");
    }
    ...
    private static Stream<Arguments> caseRoles() {
        return Stream.of(
            Arguments.of("ADMINISTRADOR", true, ""),
            ...
            Arguments.of("", false, "Nombre del rol requerido")    // válido porque "" tiene tamaño 0
        );
    }
}